...
def _patch_generator(text_or_callable):
    ...
    def fake_run_text_batch(
        ...
        *,
        ...
        return [
            fake_run_text(self, p, max_new_tokens=max_new_tokens, seed=s, schema=schema)
    ...
    return patch.multiple(
        ...
        run_text_batch=fake_run_text_batch,
...
def test_spoken_clip_pass_writes_clip_label(db_engine):
    ...
    class _SpokenGen:
        def run_text(self, prompt, *, max_new_tokens, seed=None, schema=None):
